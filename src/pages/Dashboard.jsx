      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mt-8">
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-2">Widget Script</h3>
            <p className="text-slate-600 mb-6">Generate and manage your chatbot widget script</p>
            
            <button
              onClick={() => console.log('Generate script clicked')}
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors flex items-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105 mx-auto"
            >
